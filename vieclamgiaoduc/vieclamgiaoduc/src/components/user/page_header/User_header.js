            ...
            <nav className="navbar ta-top">
                <div className="container-fluid px-30">
                    ...
                    <ul className="nav navbar-nav navbar-left">
                            ...
                            <div className="group-hover:menu navbar__item__dropdown-menu">
                                <ul className="nav navbar-menu">
                                    <li className="navbar-menu__item ">
                                        <a href="/tim-viec/a" className="text-sm">
                                    ...
                                    <li className="navbar-menu__item ">
                                        <a href="https://www.topcv.vn/viec-lam-it" className="text-sm">
                        ...
                        <li className="navbar-left__item group">
                            <a href="" title="Nhà tuyển dụng">
                                Nhà tuyển dụng
                            </a>
                            <div className="group-hover:menu navbar__item__dropdown-menu">
                                <ul className="nav navbar-menu">
                                    ...
                                    <li className="navbar-menu__item mt-0 ">
                                        <a href="" className="text-sm">
                                            <i className="icon fa-light fa-buildings"></i>
                                            Top nhà tuyển dụng
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li className="navbar-left__item group">
                            <a href="/thong-ke" title="Hồ sơ & CV" id="hosocv">
                                Tổng quan thống kê ngành Giáo dục
                            </a>
                        </li>
                        ...
                        <li className='navbar-right__item group'>
                         ...
                         <div className="group-hover:menu navbar__item__dropdown-menu">
                            <ul className="nav navbar-menu">
                                    ...
                                    <p className="description">Mã ứng viên: <span className="code">{datauser.maungvien}</span></p>
                                    <p className="description">{datauser.email}</p>
                                    </div>
                                    </div>
                                    <li className="navbar-menu__item ">
                                    <a href="https://www.topcv.vn/cai-dat-thong-tin-ca-nhan" className="text-sm">
                                    <i className="icon fa-regular fa-pen-to-square"></i>
                                    Cài đặt thông tin cá nhân
                                    </a>
                                    </li>
                                    {/* <li className="navbar-menu__item ">
                                    <a href="https://www.topcv.vn/tai-khoan/nang-cap" className="text-sm">
                                    ...
                                    <li className="navbar-menu__item ">
                                        ...
                                        <i className="icon fa-regular fa-eye"></i>
                                           Xem danh sách  kết quả  công việc đã ứng tuyển 
                                        </a>
                                    </li>
                                    {/* <li className="navbar-menu__item ">
                                    ...
                                    <li className="navbar-menu__item ">
                                    <a href="https://www.topcv.vn/tai-khoan/bao-mat" className="text-sm">
                                    <i className="icon fa-regular fa-shield-check"></i>
                                    Cài đặt bảo mật
                                    </a>
                                    </li>
                                    <li className="navbar-menu__item  tag-border">
                                    <a href="https://www.topcv.vn/tai-khoan/mat-khau" className="text-sm">
