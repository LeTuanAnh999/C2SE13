      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        ...
        >
          ...
          <Menu.Item key="3" icon={<BookOutlined />}>
            <Link to="/admin/nav3">Tin tuyển dụng</Link>
          </Menu.Item>
          <Menu.Item key="2" icon={<UsergroupAddOutlined />}>
            <Link to="/admin/nav2">Nhà tuyển dụng</Link>
          </Menu.Item>
          <Menu.Item key="4" icon={<UserOutlined />}>
            <Link to="/admin/nav5">Ứng viên</Link>
          </Menu.Item>
          <Menu.Item key="5" icon={<QrcodeOutlined />}>
            <Link to="/admin/nav6">Thanh toán</Link>
          </Menu.Item>
          <Menu.Item key="6" icon={<QuestionCircleOutlined />}>
            <Link to="/admin/nav4">Trợ giúp</Link>
          </Menu.Item>
          <Menu.Item key="7" icon={<AreaChartOutlined />}>
            <Link to="/admin/nav7">Doanh thu</Link>
          </Menu.Item>
