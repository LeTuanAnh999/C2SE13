...
export const postAPI = (url, data) => {
  ...
  // nganh nghe
    ...
    export const  getdulieuthongke= async () => {
        ...
        export const  getdanhsachvieclamadmin= async () => {
          try {
            const headers = {
              'Content-Type': 'application/json' ,// Thêm tiêu đề Content-Type
            ...
            // console.log(headers)
            return axios.get(baseURL + "/api/v1/getalljob_admin", { headers });
          } catch (error) {
            console.log("lỗi api:", error);
          }
        };
        ...
        export const  duyetinadmin= async (data) => {
          try {
            const headers = {
              'Content-Type': 'application/json' ,// Thêm tiêu đề Content-Type
            ...
            // console.log(headers)
            return axios.post(baseURL + "/api/v1/duyettin_admin",data ,{ headers });
          } catch (error) {
            console.log("lỗi api:", error);
          }
        };

        // danh sachs nhaf tuyen dung
        export const  danhsachnhatuyendungadminapi= async () => {
          try {
            const headers = {
              'Content-Type': 'application/json' ,// Thêm tiêu đề Content-Type
            ...
            // console.log(headers)
            return axios.get(baseURL + "/api/v1/getlistdanhsachnhatuyendungnew" ,{ headers });
          } catch (error) {
            console.log("lỗi api:", error);
          }
        };
          // danh sach ưng viên
        export const  danhsachungvienadminapi= async () => {
          try {
            const headers = {
              'Content-Type': 'application/json' ,// Thêm tiêu đề Content-Type
            ...
            // console.log(headers)
            return axios.get(baseURL + "/api/v1/getlistdanhsachunviennew" ,{ headers });
          } catch (error) {
            console.log("lỗi api:", error);
          }
        };