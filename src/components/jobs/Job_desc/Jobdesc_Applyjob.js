...
import { chitietcongviecapi } from '../../api/Jobapi/Jobapi';
...
function Jobdesc_Applyjob() {
  ...
  const [listimage,setimages] = useState([])
  const [khuvuclamviecs,setkhuvuclamviecs] = useState([])
  const fectdata = async()=>{
    const lastIndex = url.lastIndexOf('.');

    // Kiểm tra nếu tìm thấy dấu chấm
    if (lastIndex !== -1) {
      // Sử dụng `substring` để lấy ký tự '30' từ vị trí cuối cùng của dấu chấm
      var postid = url.substring(lastIndex + 1);
      
      const data = new FormData();
      data.append("post_new_ids ",postid)
      const result = await chitietcongviecapi(data)
      setdata(result.data.data[0])

      const listimagejson = formatJson(result.data.data[0].images)
      const listdiadiem = formatJson(result.data.data[0].khuvuclamviec)
      console.log(listimagejson)
      console.log(listdiadiem)
      setimages(listimagejson)
      setkhuvuclamviecs(listdiadiem)
      console.log(result)
  ...
  function formatNumber(number) {
    ...
    const hideModal = async(id) => {
      ...
      if(checklogin == true){
          ...
          data.append("filedata",fileInfo.fileData);
          data.append("thoigian",currentDateTime);
          data.append("content",content)

          if(fileInfo.fileData !== null && content.length !== 0){
    ...
    const [kinhgnhiem,setkinhnghiem] = useState("");
    ...
    //cấp bậc
    const hanldekinhnghiem  =(selected)=>{
        setkinhnghiem(selected)
    }
    //mức lương
    ...
    const Submittimviec=()=>{
            ...
            if (kinhgnhiem !== "") {
            queryParams.push(`kinhnghiem=${(kinhgnhiem.value)}`);
            }
            if(tencongviec == "" && diadiemcv.value == ""  && mucluong.value =="" && kinhgnhiem.value ==""){
    ...
    <div className='job-apply' id ='main' style={{marginTop:"4.888rem"}}>
            ...
            <div className='container'>
              <div id="frm-search-job">
                ...
                <div className='group-search'>
                  ...
                  <input className="form-controlui-className-input ui-className-input"  placeholder="tên công việc tuyển dụng" id="keyword" value={tencongviec} onChange={handleChange} >
                  </input>
                  </div>
                  <div className='item search-city'>
                <i className="fa-regular fa-location-dot"></i>
                <Select options={optionsdiadiemlamviec} value={diadiemcv} onChange={handleCityChange}
                ...
                <div className='group'>
                  <div className='item group-item-experience'>
                    ...
                    <Select options={optionkinhnghiem}
                         value={kinhgnhiem} onChange={hanldekinhnghiem}
                  ...
                  <div className='item group-item-salary'>
                   <div className="icon">
                    ...
                    <Select options={options}
                         value={mucluong} onChange={hanldemucluong}
                ...
                <div className="col-button">
                 <button className="btn btn-topcv btn-search-job" type="submit" onClick={Submittimviec}>Tìm kiếm</button>
                </div>
      ...
      <div className='container job-detail' id="job-detail">
        <div className="ctn-breadcrumb-detail">
          ...
          <span className="text-dark-blue">{data.tieudetuyendung}</span>
          </div>
          ...
          <div className='job-detail__header'>
            <div className='job-detail__box--left job-detail__info' id="header-job-info">
              <h1 className="job-detail__info--title ">
                  {/* <a href="/" className="text-highlight" target="_blank"></a>  */}
                  {data.tieudetuyendung}
              </h1>
              ...
              <div className='job-detail__info--sections'>
                <div className='job-detail__info--section'>
                  <div className='job-detail__info--section-icon'>
                   ...
                   <div className='job-detail__info--section-content'>
                    <div className="job-detail__info--section-content-title">Mức lương  ({data.is_luong})</div>
                    <div className="job-detail__info--section-content-value">{data.length == 0?"":data.is_kieuluong =="Thỏa thuận"?"Thỏa Thuận":<>Trên:{ formatNumber(data.is_tu)} </>}</div>
                   </div>
                ...
                <div className="job-detail__info--section">
                  ...
                  <div className="job-detail__info--section-content-value">{  data.length ==0?"": formatJson(data.khuvuclamviec)[0].value}</div>
                  </div>
                </div>
              ...
              <div className='job-detail__info--sections'>
                <div className='job-detail__info--section'>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                   ...
                   <div className='job-detail__info--section-content'>
                    ...
                    <div className="job-detail__info--section-content-value">{data.hinhthuccongviec}</div>
                   </div>
                ...
                <div className="job-detail__info--section">
                  ...
                  <div className="job-detail__info--section-content-value">{data.capbac}</div>
                  </div>
                </div>
                ...
                <div className="job-detail__info--section">
                  ...
                  <div className="job-detail__info--section-content-value">{data.kinhnghiem}</div>
                  </div>
                </div>
              ...
              <div className='job-detail__info--sections'>
                <div className='job-detail__info--section'>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                   ...
                   <div className='job-detail__info--section-content'>
                    ...
                    <div className="job-detail__info--section-content-value">{data.soluongtuyen}</div>
                   </div>
                ...
                <div className="job-detail__info--section">
                  ...
                  <div className="job-detail__info--section-content-value">{data.gioitinh}</div>
                  </div>
                </div>
...
{/* end */}
              ...
              <div className="job-detail__info--deadline ">
                  ...
                  Hạn nộp hồ sơ:  {songay(data.time_cv)=== 0?"Hết hạn": <span>Còn <strong>{songay(data.time_cv)}</strong> ngày để ứng tuyển</span> }
                </div>

                <div className="job-detail__info--actions box-apply-current">

                {songay(data.time_cv)== 0? <button data-redirect-to="" disabled="true"  style={{width:"80%"}}className="job-detail__info--actions-button button-primary " >
                          <span className="button-icon">
                          <i className="fa-light fa-paper-plane"></i>
                          </span>
                          Ứng tuyển ngay
                    </button>:<button  style={{width:"80%"}}className="job-detail__info--actions-button button-primary "  onClick={() => Applyjob(data.post_new_id)}>
                          <span className="button-icon">
                          <i className="fa-light fa-paper-plane"></i>
                          </span>
                          Ứng tuyển ngay
            ...
            <div className='job-detail__company--information'>
                <div className="job-detail__company--information-item company-name">
                  <a className="company-logo" href="https://www.topcv.vn/cong-ty/cong-ty-tnhh-mot-thanh-vien-su-thien-thanh/133820.html" target="_blank" data-toggle="tooltip" title="" data-placement="top" data-original-title="">
                  <img src={data.image == null?logo:data.image} alt="" className="img-responsive"  style={{maxWidth:"99%"}}/>
                  </a>
                  <h2 className="company-name-label">
                  <a className="name" href="https://www.topcv.vn/cong-ty/cong-ty-tnhh-mot-thanh-vien-su-thien-thanh/133820.html" target="_blank" data-toggle="tooltip" title="" data-placement="top" data-original-title={data.name_cty}>{data.name_cty}</a>
                ...
                <div className="job-detail__company--information-item company-scale">
                  ...
                  <div className="company-value">{data.quymo} nhân viên</div>
                </div>
            ...
            {/* <a href={ data.length == 0?"": "/cong-ty/"+slugVietnamese(data.name_cty)+"."+data.user_id} target="_blank">Xem trang công ty</a> */}
              ...
              <div className='job-detail__information-detail--content'>
                <div className='job-images'>
                  <div className='list-image-company' id="list-image-company">
                    ...
                    {/* {listimage.length == 0?"":   listimage.length ==1? <img src={listimage[0].image} className="img-responsive"></img>:""}
                    {listimage.length == 0?"":   listimage.length ==2? <><img src={listimage[0].image} className="img-responsive"></img> <img src={listimage[1].image} className="img-responsive"></img> </>:""}
                    
                    {listimage.length == 0?"":   listimage.length ==3? <><img src={listimage[0].image} className="img-responsive"></img> <img src={listimage[1].image} className="img-responsive"></img> <img src={listimage[2].image} className="img-responsive"></img> </>:""} */}
                   
                   
                   {data.length == 0? "":(
                          listimage.map((item,index)=>{
                            return<> <img src={item.image} className="img-responsive"></img></>
                ...
                <div className='job-description'>
                    ...
                    {data.length === 0 ? null : (
                        <div dangerouslySetInnerHTML={{ __html: data.motacongviec }} />
                      )}
                    </div>
                    <div className="job-description__item">
                      ...
                      <div className="job-description__item--content">
                      {data.length === 0 ? null : (
                        <div dangerouslySetInnerHTML={{ __html: data.yeucauungvien }} />
                      )}
                      </div>
                    </div>
                    ...
                    <div className="job-description__item">
                      ...
                      <div className="job-description__item--content">
                      {data.length === 0 ? null : (
                        <div dangerouslySetInnerHTML={{ __html: data.quyenloiungvien}} />
                      )}
                      </div>
                    </div>
                    <div className="job-description__item">
                ...
                <div className="job-detail__information-detail--actions">
                   ...
                   {songay(data.time_cv)== 0? <button data-redirect-to="" disabled="true"  style={{width:"50%"}}className="job-detail__info--actions-button button-primary " >
                          <span className="button-icon">
                          <i className="fa-light fa-paper-plane"></i>
                          </span>
                          Ứng tuyển ngay
                    </button>:<button  style={{width:"50%"}}className="job-detail__info--actions-button button-primary " onClick={() => Applyjob(data.post_new_id)} >
                          <span className="button-icon">
                          <i className="fa-light fa-paper-plane"></i>
                          </span>
                          Ứng tuyển ngay
                    ...
                    Hạn nộp hồ sơ:  {songay(data.time_cv)=== 0?"Hết hạn": <span>Còn <strong>{songay(data.time_cv)}</strong> ngày để ứng tuyển   -  {data.time_cv}</span> }
                    </div>
                    </div>
