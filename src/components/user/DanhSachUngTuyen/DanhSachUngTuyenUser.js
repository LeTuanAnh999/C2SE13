...
import { getlistpostapplyjobapi } from '../../api/Jobapi/Jobapi';
import "./style.css"
import logo from "../page_header/LOGO.png"
const slugVietnamese = require('slug-vietnamese');
function DanhSachUngTuyenUser() {
    ...
    const getalldata = async()=>{
        ...
        const result = await getlistpostapplyjobapi(data);
...
export default DanhSachUngTuyenUser