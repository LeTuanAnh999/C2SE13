...
const SkillDescriptionInputHD = ({  cvo_placeholder,edukey}) => {
...
const divRef = useRef(null);
  ...
  const hanlderclick =(key)=>{
    try {
      // const divContent = divRef.current.innerText;
        ...
        styleElem.innerHTML = "#input-skill-hd:before { content:''}";
  ...
  const viewCn=()=>{
    document.getElementById("fieldgroup_controlsv-hd").style.display = "block";
  }
  const HideCn=()=>{
    document.getElementById("fieldgroup_controlsv-hd").style.display = "none";
  }
  return (
    <div className="edit-skill-kn"  id="hideskill"onClick={viewCn} >
      <div className="fieldgroup_controls"  id="fieldgroup_controlsv-hd" onMouseLeave={(HideCn)} >
...
export default SkillDescriptionInputHD;
