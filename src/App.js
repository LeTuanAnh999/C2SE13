...
import DanhSachUngTuyenUser from './components/user/DanhSachUngTuyen/DanhSachUngTuyenUser';
import Settingcanhan from './components/user/Settingcanhan/Settingcanhan';
import Settingpassword from './components/user/Settingpassword/Settingpassword';
import SettingNhuCauTV from './components/user/SettingNhuCauTV/SettingNhuCauTV';
import DanhSachDaLuu from './components/user/DanhSachDaLuu/DanhSachDaLuu';
import DanhSachNhaTuyenDung from './components/user/DanhSachNhaTuyenDung/DanhSachNhaTuyenDung';
import TimKiemDaNenTang from './components/user/TimKiemDaNenTang/TimKiemDaNenTang';
function App() {
  return (
    ...
    <div className="App">
         <Routes>
                  ...
                  < Route path='/danh-sach-ung-tuyen' element={<DanhSachUngTuyenUser />}/>
                  < Route path='/danh-sach-nha-tuyen-dung' element={<DanhSachNhaTuyenDung />}/>
                  < Route path='/danh-sach-da-luu' element={<DanhSachDaLuu/>}/>
                  < Route path='/tai-khoan-ca-nhan' element={<Settingcanhan />}/>
                  < Route path='/tim-kiem-da-nen-tang' element={<TimKiemDaNenTang/>}/>
                  < Route path='/tai-khoan-mat-khau' element={<Settingpassword />}/>
                  < Route path='//cai-dat-nhu-cau-tim-viec' element={<SettingNhuCauTV/>}/>
